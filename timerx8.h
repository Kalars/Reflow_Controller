...
//timer2 has 2 ouput compare interrupts
#define TIMER2OUTCOMPAREA_INT		6
#define TIMER2OUTCOMPAREB_INT		7

#ifdef OCR0	// for processors that support output compare on Timer0
#define TIMER0OUTCOMPARE_INT		8
#define TIMER_NUM_INTERRUPTS		9
#else
#define TIMER_NUM_INTERRUPTS		8
#endif

//Mega x8 has 2 output compares (A & B) for timer0
#ifdef	OCR0A
	#define TIMER0OUTCOMPAREA_INT		8
	#define TIMER0OUTCOMPAREB_INT		9
	
	#undef	TIMER_NUM_INTERRUPTS
